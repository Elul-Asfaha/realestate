...
const Testimonies = () => {
    return (
        <div className='flex flex-col px-[10%] pb-5 md:pt-5 bg-gray-900 text-white min-h-[50vh]'>
            <div className='flex flex-col items-center gap-5 md:flex-row md:justify-between py-5'>
                <p className='md:flex-1 text-3xl md:text-6xl text-center md:text-ellipsis max-w-[400px]'>
                    Customer are our priority
                </p>

                <p className='md:flex-1 max-w-[350px] text-center md:text-ellipsis'>
